...
public class BookMussoorieActivity extends AppCompatActivity {
    Button btnGangtok;
    Calendar myCalender;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_book_mussoorie);
        ...
        duration="10";
        packageId="TRAVELMANIA001MUSSOORIE01";
        packageCost="21999";
        extraInclusion="ParaGliding";
        picUp="Delhi";
        dropOff="Delhi";
