...
public class Gangtok_book_Activity extends AppCompatActivity {
    Button btnGangtok;
    Calendar myCalender;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gangtok_book);
        ...
        ArrayAdapter<String> passengerAdapter=new ArrayAdapter<>(Gangtok_book_Activity.this,R.layout.support_simple_spinner_dropdown_item,passenger);
        ...
        departureInput.setOnClickListener(v -> {
            new DatePickerDialog(Gangtok_book_Activity.this,date,myCalender
        ...
        duration="7";
        packageId="TRAVELMANIA001GANGTOK01";
        packageCost="15999";
        extraInclusion=null;
        picUp="Howrah";
        dropOff="Howrah";
